...
class AttentionWithFastKAFTransform(nn.Module):
    def __init__(self, input_dim: int, output_dim: int, num_grids: int = 8, dropout_rate: float = 0, use_layernorm: bool = True, activation_expectation: float = 1.64):
        super().__init__()
        self.fastKAF = KAF(input_dim, output_dim, num_grids, dropout_rate, use_layernorm, activation_expectation)
